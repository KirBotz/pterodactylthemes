...
portuguese(){
    bash <(curl https://raw.githubusercontent.com/KirBotz/pterodactylthemes/main/instaladorportugues.sh)
}

german(){
    bash <(curl https://raw.githubusercontent.com/KirBotz/pterodactylthemes/main/instaladorgerman.sh)
}

english(){
    bash <(curl https://raw.githubusercontent.com/KirBotz/pterodactylthemes/main/instaladorenglish.sh)
}
